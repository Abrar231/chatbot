...
export default async function RootLayout({children,}: Readonly<{children: React.ReactNode}>) {
  ...
  if(error){
    return (
      <div>Error occurred while fetching chats</div>
    )
  }
  ...
  return (
    <html lang="en">
      ...
      <div className="flex h-screen">
          <div className="w-96 h-full flex flex-col bg-lightShade py-2 px-3">
            <div className="flex justify-end ">
              <Link href='/' className="h-10 rounded-lg px-2 focus-visible:outline-0 focus-visible:bg-shade enabled:hover:bg-shade">
            ...
            <nav className="flex-grow mb-1  overflow-y-auto">
              ...
              {!data || data.length === 0? 
                <div className="text-xl">No chats to display</div>:
                <div className="">
